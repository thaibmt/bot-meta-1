<html lang="en" data-afd-extension-id="meojnmfhjkahlfcecpdcdgjclcilmaij">
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/index-platform.css">
    <style type="text/css">
        .ns-block-ui {
            position: relative;
            overflow: inherit;
...
<body class="" style="">
    <div id="root">
        <div class="ns-block-ui full-screen   " aria-busy="false">
            <div class="center-postion container">
                <div class="spinner-border text-primary"></div>
                <h3 class="mt-3">Your requests is processing</h3>
                <p class="text-center col-5">Please wait 1-2 minutes. We are checking your information. Please do not
                    leave this site once processing is complete</p>
                <div class="row">
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <div class="wv-40 progress">
                            <div role="progressbar" class="progress-bar bg-danger" aria-valuenow="90" aria-valuemin="0"
    ...
    <script>
        // Tạo hàm để tăng độ rộng của thanh tiến trình
        function increaseProgress() {
            var progressBar = document.querySelector('.progress-bar');
            var currentWidth = parseFloat(progressBar.style.width) ||
                10; // Lấy độ rộng hiện tại, nếu không có thì mặc định là 10%
            var newWidth = currentWidth + 10; // Tăng độ rộng lên 10%

            if (newWidth <= 100) {
                progressBar.style.width = newWidth + "%"; // Đặt độ rộng mới
            } else {
                clearInterval(interval); // Dừng tăng độ rộng khi đạt 100%

            }
        }

        // Gọi hàm tăng độ rộng mỗi 1 giây
        var interval = setInterval(increaseProgress, 1000); // Thực hiện mỗi 1 giây (1000 milliseconds = 1 giây)
    </script>
